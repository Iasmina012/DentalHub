...
public class Activity_ChangePassword_Roles extends AppCompatActivity {
        ...
        if (user != null && user.getEmail().equals(email)) {
            user.updatePassword(newPasswordStr).addOnCompleteListener(task -> {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(Activity_ChangePassword_Roles.this, "Password changed successfully", Toast.LENGTH_SHORT).show();
                    goToNextActivity();
                } else {
                    Toast.makeText(Activity_ChangePassword_Roles.this, "Failed to change password", Toast.LENGTH_SHORT).show();
                }
            });
        }
    ...
    private void goToAdminActivity() {
        ...
        Intent intent = new Intent(Activity_ChangePassword_Roles.this, AdminActivity.class);
    ...
    private void goToDoctorActivity() {
        ...
        Intent intent = new Intent(Activity_ChangePassword_Roles.this, DoctorActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(intent);
        overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);
